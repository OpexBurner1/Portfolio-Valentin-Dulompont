export default Vue.component('FooterTemplate', {
    template: `
        <footer class="footer">
            ...
            <p>Ce matériel pédagogique est la propriété de la <a rel="license" href="https://3wa.fr/propriete-materiel-pedagogique/">3W Academy</a>. Cet exercice a été réalisé par Séverinne , Jonathan , Mathieu et Valentin.</p>
        </footer>`,
    data() {
        return {
        };
